      ...
      onSubmit={handleSubmit(async data => {
        ...
        try {
          ...
          if (result.status === 200) {
            ...
            //실패 케이스
            toast.error('맛집을 등록에 실패했습니다.');
          }
        } catch (e) {
          console.log(e);
          toast.error('데이터 생성 중 오류 발생');
        }
      })}
    >
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input
                  ...
                  className="block w-full rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 outline-none px-2"
                />
            ...
            <div className="sm:col-span-2">
              <label htmlFor="stroeType" className="block text-sm font-medium leading-6 text-gray-900">
                업종구분
              </label>
              <div className="mt-2">
                <select
                  {...register('stroeType', { required: true })}
                  className="px-2 *:block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                >
